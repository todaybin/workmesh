...
export type ComposeFinishProgress = {
  action: "local_merge" | "create_pr" | "push" | "keep" | "discard"
  stage: "prepared" | "git_completed" | "cleanup_completed"
  startedAt: number
  gitCompletedAt?: number
...
export type ComposeGit = {
  baseBranch?: string
  baseSha?: string
  headSha?: string
  baseDirty?: boolean
  workspaceStrategy?: "clean_head" | "include_working"
  ...
  finishAction?: "local_merge" | "create_pr" | "push" | "keep" | "discard"
  finishProgress?: ComposeFinishProgress
}

export type ComposeInfo = {
  schemaVersion: "workmesh.compose.v1"
  id: string
  projectRoot: string
  sessionID?: string
  mode: "automatic" | "interactive"
  taskType: "feature" | "bugfix" | "refactor" | "feedback"
  task: string
  featureName?: string
  ...
  phase:
    ...
    | "failed"
    | "discarded"
  status: "running" | "awaiting_approval" | "awaiting_finish" | "cancelled" | "failed" | "completed" | "discarded"
  ...
  pendingFixKind?: "verify" | "review"
  pendingFixes?: Array<string>
  ...
  completedAt?: number
  lastError?: string
  tasks: Array<ComposeTask>
  amendments: Array<ComposeAmendment>
  spec?: ComposeSpec
...
export type EventComposeRunUpdated = {
  id: string
  type: "compose.run.updated"
  properties: {
    run: ComposeInfo
...
export type TuiWorkmeshTerminalsData = {
  body?: never
  path?: never
  query: {
    directory?: string
  ...
  url: "/tui/workmesh/terminals"
}

export type TuiWorkmeshTerminalsErrors = {
  /**
   * InvalidRequestError
   */
...
export type TuiWorkmeshTerminalsError = TuiWorkmeshTerminalsErrors[keyof TuiWorkmeshTerminalsErrors]

export type TuiWorkmeshTerminalsResponses = {
  /**
   * WorkMesh terminals available for messaging
   */
  200: {
    ...
    items: Array<{
      ...
      workspaceMode: "shared" | "locked" | "isolated"
      current: boolean
    }>
  }
}

export type TuiWorkmeshTerminalsResponse = TuiWorkmeshTerminalsResponses[keyof TuiWorkmeshTerminalsResponses]

export type TuiWorkmeshMessageData = {
  body?: {
    sessionID: string
  ...
  url: "/tui/workmesh/message"
}

export type TuiWorkmeshMessageErrors = {
  /**
   * InvalidRequestError
   */
  400: InvalidRequestError
...
export type TuiWorkmeshMessageError = TuiWorkmeshMessageErrors[keyof TuiWorkmeshMessageErrors]

export type TuiWorkmeshMessageResponses = {
  /**
   * WorkMesh message queued
   */
  200: {
    id: string
    status: string
...
export type TuiWorkmeshMessageResponse = TuiWorkmeshMessageResponses[keyof TuiWorkmeshMessageResponses]

export type TuiWorkmeshMessagesData = {
  body?: never
  path?: never
  query: {
    directory?: string
  ...
  url: "/tui/workmesh/messages"
}

export type TuiWorkmeshMessagesErrors = {
  /**
   * InvalidRequestError
   */
  400: InvalidRequestError
...
export type TuiWorkmeshMessagesError = TuiWorkmeshMessagesErrors[keyof TuiWorkmeshMessagesErrors]

export type TuiWorkmeshMessagesResponses = {
  /**
   * WorkMesh terminal conversation messages
   */
  200: {
    items: Array<{
      id: string
...
export type TuiWorkmeshMessagesResponse = TuiWorkmeshMessagesResponses[keyof TuiWorkmeshMessagesResponses]

export type TuiWorkmeshEventsData = {
  body?: never
  path?: never
  query: {
    directory?: string
  ...
  url: "/tui/workmesh/message/events"
}

export type TuiWorkmeshEventsErrors = {
  /**
   * InvalidRequestError
   */
  400: InvalidRequestError
...
export type TuiWorkmeshEventsError = TuiWorkmeshEventsErrors[keyof TuiWorkmeshEventsErrors]

export type TuiWorkmeshEventsResponses = {
  /**
   * WorkMesh terminal message events after cursor
   */
  200: {
    items: Array<{
...
export type TuiWorkmeshEventsResponse = TuiWorkmeshEventsResponses[keyof TuiWorkmeshEventsResponses]

export type TuiWorkmeshClaimData = {
  body?: {
    sessionID: string
    messageId: string
    result?: string
  ...
  url: "/tui/workmesh/message/claim"
}

export type TuiWorkmeshClaimErrors = {
  /**
   * InvalidRequestError
   */
  400: InvalidRequestError
...
export type TuiWorkmeshClaimError = TuiWorkmeshClaimErrors[keyof TuiWorkmeshClaimErrors]

export type TuiWorkmeshClaimResponses = {
  /**
   * WorkMesh message claimed
   */
  200: {
    id: string
    senderTerminalId: string
...
export type TuiWorkmeshClaimResponse = TuiWorkmeshClaimResponses[keyof TuiWorkmeshClaimResponses]

export type TuiWorkmeshCompleteData = {
  body?: {
    sessionID: string
    messageId: string
    result?: string
  ...
  url: "/tui/workmesh/message/complete"
}

export type TuiWorkmeshCompleteErrors = {
  /**
   * InvalidRequestError
   */
  400: InvalidRequestError
...
export type TuiWorkmeshCompleteError = TuiWorkmeshCompleteErrors[keyof TuiWorkmeshCompleteErrors]

export type TuiWorkmeshCompleteResponses = {
  /**
   * WorkMesh message completed
   */
  200: {
    id: string
    senderTerminalId: string
...
export type TuiWorkmeshCompleteResponse = TuiWorkmeshCompleteResponses[keyof TuiWorkmeshCompleteResponses]

export type TuiWorkmeshFailData = {
  body?: {
    sessionID: string
    messageId: string
    result?: string
  ...
  url: "/tui/workmesh/message/fail"
}

export type TuiWorkmeshFailErrors = {
  /**
   * InvalidRequestError
   */
  400: InvalidRequestError
...
export type TuiWorkmeshFailError = TuiWorkmeshFailErrors[keyof TuiWorkmeshFailErrors]

export type TuiWorkmeshFailResponses = {
  /**
   * WorkMesh message failed
   */
  200: {
    id: string
    senderTerminalId: string
...
export type TuiWorkmeshFailResponse = TuiWorkmeshFailResponses[keyof TuiWorkmeshFailResponses]

export type TuiWorkmeshProgressData = {
  body?: {
    sessionID: string
    messageId: string
    delta: string
  ...
  url: "/tui/workmesh/message/progress"
}

export type TuiWorkmeshProgressErrors = {
  /**
   * InvalidRequestError
   */
  400: InvalidRequestError
...
export type TuiWorkmeshProgressError = TuiWorkmeshProgressErrors[keyof TuiWorkmeshProgressErrors]

export type TuiWorkmeshProgressResponses = {
  /**
   * WorkMesh message progress reported
   */
  200: boolean
}

export type TuiWorkmeshProgressResponse = TuiWorkmeshProgressResponses[keyof TuiWorkmeshProgressResponses]
