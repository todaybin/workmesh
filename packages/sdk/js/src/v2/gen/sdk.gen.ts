...
import type {
  ...
  TuiWorkmeshClaimErrors,
  TuiWorkmeshClaimResponses,
  TuiWorkmeshCompleteErrors,
  TuiWorkmeshCompleteResponses,
  TuiWorkmeshEventsErrors,
  TuiWorkmeshEventsResponses,
  TuiWorkmeshFailErrors,
  TuiWorkmeshFailResponses,
  TuiWorkmeshMessageErrors,
  TuiWorkmeshMessageResponses,
  TuiWorkmeshMessagesErrors,
  TuiWorkmeshMessagesResponses,
  TuiWorkmeshProgressErrors,
  TuiWorkmeshProgressResponses,
  TuiWorkmeshTerminalsErrors,
  TuiWorkmeshTerminalsResponses,
  V2AgentListErrors,
...
export class Workmesh extends HeyApiClient {
  /**
   * List WorkMesh terminals
   *
   * Register the current WorkMesh session terminal and list messaging targets.
   */
  public terminals<ThrowOnError extends boolean = false>(
    parameters: {
      directory?: string
      workspace?: string
      sessionID: string
  ...
  /**
   * Send WorkMesh terminal message
   *
   * Send one short message from the current WorkMesh session terminal.
   */
  public message<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
      ...
      [
        {
          args: [
            ...
            { in: "query", key: "workspace" },
            { in: "body", key: "sessionID" },
            { in: "body", key: "recipientTerminalId" },
            { in: "body", key: "message" },
    ...
    return (options?.client ?? this.client).post<TuiWorkmeshMessageResponses, TuiWorkmeshMessageErrors, ThrowOnError>({
  ...
  /**
   * List WorkMesh messages
   *
   * List the current terminal conversation messages.
   */
  public messages<ThrowOnError extends boolean = false>(
    parameters: {
      directory?: string
      ...
      [
        {
          args: [
            ...
            { in: "query", key: "workspace" },
            { in: "query", key: "sessionID" },
            { in: "query", key: "peerTerminalId" },
            { in: "query", key: "status" },
          ],
        },
      ],
    )
    return (options?.client ?? this.client).get<TuiWorkmeshMessagesResponses, TuiWorkmeshMessagesErrors, ThrowOnError>({
  ...
  /**
   * List WorkMesh message events
   *
   * List local message execution events after the supplied cursor.
   */
  public events<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).get<TuiWorkmeshEventsResponses, TuiWorkmeshEventsErrors, ThrowOnError>({
  ...
  /**
   * Claim WorkMesh message
   *
   * Atomically claim a queued terminal task.
   */
  public claim<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).post<TuiWorkmeshClaimResponses, TuiWorkmeshClaimErrors, ThrowOnError>({
  ...
  /**
   * Complete WorkMesh message
   *
   * Report a terminal task result.
   */
  public complete<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).post<TuiWorkmeshCompleteResponses, TuiWorkmeshCompleteErrors, ThrowOnError>(
      {
  ...
  /**
   * Fail WorkMesh message
   *
   * Report a terminal task failure.
   */
  public fail<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).post<TuiWorkmeshFailResponses, TuiWorkmeshFailErrors, ThrowOnError>({
  ...
  /**
   * Append WorkMesh task event
   *
   * Append an execution event for the current terminal task to local SQLite.
   */
  public progress<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).post<TuiWorkmeshProgressResponses, TuiWorkmeshProgressErrors, ThrowOnError>(
      {
...
export class Tui extends HeyApiClient {
  ...
  private _workmesh?: Workmesh
  get workmesh(): Workmesh {
    return (this._workmesh ??= new Workmesh({ client: this.client }))
  }
}
