...
import { acquireWriteIntent, releaseWriteIntent } from "@/workmesh/write-intent"
    ...
    return {
      ...
      execute: (params: Schema.Schema.Type<typeof Parameters>, ctx: Tool.Context) =>
        Effect.gen(function* () {
          ...
          const writeIntent = yield* acquireWriteIntent(instance, ctx, [filePath])
          ...
          yield* lock(filePath).withPermits(1)(
            ...
            }).pipe(Effect.orDie, Effect.ensuring(releaseWriteIntent(writeIntent))),
          )
