      ...
      const dirs = yield* Effect.forEach(
        ...
        (skill) =>
          Effect.gen(function* () {
            ...
            const versionFile = path.join(root, WorkMeshProduct.enabled ? ".workmesh-version" : ".opencode-version")
            ...
            if (version === undefined || current === version) {
              ...
              yield* Effect.gen(function* () {
                ...
                yield* fs.writeFileString(
                  path.join(staging, WorkMeshProduct.enabled ? ".workmesh-version" : ".opencode-version"),
                  version,
                )
