...
export function DialogSelect<T>(props: DialogSelectProps<T>) {
  ...
  useBindings(() => {
    ...
    return {
      // The filter input remains focused while selecting. Dialog bindings must
      // take precedence over the global prompt input layer for arrows and Enter.
      priority: 1,
      target: inputTarget,
      enabled: inputTarget() !== undefined && !props.locked,
      commands: [
        {
