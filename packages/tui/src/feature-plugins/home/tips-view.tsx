...
const projectConfigDirectory = TuiProduct.enabled ? ".workmesh/config" : ".opencode"
...
const TIPS: Tip[] = [
  ...
  `Add {highlight}.md{/highlight} files to {highlight}${projectConfigDirectory}/commands/{/highlight} for reusable prompts`,
  "Use {highlight}$ARGUMENTS{/highlight}, {highlight}$1{/highlight}, {highlight}$2{/highlight} in custom commands for dynamic input",
  "Use backticks to inject shell output (e.g., {highlight}`git status`{/highlight})",
  `Add {highlight}.md{/highlight} files to {highlight}${projectConfigDirectory}/agents/{/highlight} for specialized AI personas`,
  ...
  `Create {highlight}.ts{/highlight} files in {highlight}${projectConfigDirectory}/tools/{/highlight} to define new LLM tools`,
  "Tool definitions can invoke scripts written in Python, Go, etc",
  `Add {highlight}.ts{/highlight} files to {highlight}${projectConfigDirectory}/plugins/{/highlight} for event hooks`,
  ...
  `Create JSON theme files in {highlight}${projectConfigDirectory}/themes/{/highlight} directory`,
